            ...
            <div ref={modalRef} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-11/12 md:w-3/4 pb-6 pr-6 pl-6 max-h-[80vh] overflow-y-auto">
                ...
                <div className="flex flex-col md:flex-row gap-8 mt-6">
                    ...
                    <input
                        ...
                        className="w-full p-2 border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 text-black dark:text-white rounded-md mb-4"
                    />
                ...
                <button className="w-full bg-[#4bb4a6] text-white py-2 rounded-full mt-6">Schedule My Call</button>
            </div>
        </div>
    </div>
  );
